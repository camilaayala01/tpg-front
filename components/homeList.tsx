...
export default function AppSearchBarProjects({listProject}: {listProject: [Project]}) {
    ...
    return (
        <div>
            <label className="relative bg-white min-w-sm max-w-2xl flex flex-col md:flex-row  border py-2 px-2 rounded-2xl gap-2 shadow text-black focus-within:border-gray-300"> 
